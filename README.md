...
### Standalone
The library can be used as a standalone by downloading the [metashape-1.8.0.jar](https://github.com/jseinturier/metashape-java-maven/releases/download/v1.8.0/metashape-1.8.0.jar) jar and integrating it to the classpath. 
