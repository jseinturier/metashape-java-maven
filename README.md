...
### Standalone
The library can be used as a standalone by downloading the [metashape-1.7.6.jar](https://github.com/jseinturier/metashape-java-maven/releases/download/v1.7.6/metashape-1.7.6.jar) jar and integrating it to the classpath. 
